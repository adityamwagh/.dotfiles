...
-- base UI
hl("Normal", { fg = "#ffffff", bg = "#202020" })
hl("NormalFloat", { fg = "#ffffff", bg = "#282828" })
hl("NormalNC", { fg = "#9f9f9f", bg = "#202020" })
hl("FloatBorder", { fg = "#606060", bg = "#282828" })
hl("Cursor", { fg = "#202020", bg = "#33ffa0" })
hl("CursorLine", { bg = "#1d1d1d" })
hl("CursorLineNr", { fg = "#33ffa0", bold = true })
hl("LineNr", { fg = "#bfbfbf" })
hl("SignColumn", { bg = "#202020" })
hl("ColorColumn", { bg = "#1d1d1d" })
hl("Visual", { bg = "#144364" })
hl("Search", { fg = "#202020", bg = "#33ffa0" })
hl("IncSearch", { fg = "#202020", bg = "#33ffff" })
hl("Pmenu", { fg = "#ffffff", bg = "#282828" })
hl("PmenuSel", { fg = "#202020", bg = "#33bbff" })
hl("PmenuSbar", { bg = "#282828" })
hl("PmenuThumb", { bg = "#606060" })
hl("StatusLine", { fg = "#ffffff", bg = "#303030" })
hl("StatusLineNC", { fg = "#9f9f9f", bg = "#202020" })
hl("TabLine", { fg = "#9f9f9f", bg = "#282828" })
hl("TabLineSel", { fg = "#ffffff", bg = "#202020" })
hl("TabLineFill", { bg = "#282828" })
hl("WinSeparator", { fg = "#303030" })
hl("VertSplit", { fg = "#303030" })
hl("Folded", { fg = "#9f9f9f", bg = "#1d1d1d" })
hl("FoldColumn", { fg = "#606060", bg = "#202020" })
hl("MatchParen", { fg = "#33ffa0", bold = true })
hl("NonText", { fg = "#484848" })
hl("Whitespace", { fg = "#484848" })
hl("EndOfBuffer", { fg = "#202020" })
hl("WildMenu", { fg = "#202020", bg = "#33bbff" })

-- syntax (Kate canonical)
hl("Comment", { fg = "#707070", italic = true })
hl("Constant", { fg = "#33ffff", bold = true })
hl("String", { fg = "#00ee00" })
hl("Character", { fg = "#33bbff" })
...
hl("Statement", { fg = "#33bbff" })
hl("Keyword", { fg = "#33bbff", bold = true })
...
hl("Type", { fg = "#33ffff" })
hl("StorageClass", { fg = "#33bbff", bold = true })
...
hl("Underlined", { fg = "#33bbff", underline = true })
...
hl("DiagnosticUnderlineInfo", { undercurl = true, sp = "#33bbff" })
hl("DiagnosticUnderlineHint", { undercurl = true, sp = "#33ffa0" })

-- diff / git
hl("DiffAdd", { fg = "#5fff33", bg = "#1d1d1d" })
hl("DiffChange", { fg = "#ff9233", bg = "#1d1d1d" })
hl("DiffDelete", { fg = "#ff3344", bg = "#1d1d1d" })
hl("DiffText", { fg = "#33bbff", bg = "#1d1d1d" })
