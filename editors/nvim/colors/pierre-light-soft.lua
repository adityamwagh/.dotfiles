-- Pierre Light Soft.
-- NOTE: diverges from upstream. Upstream pairs this variant's soft chrome with
-- the vivid ANSI ramp (string #0dbe4e, number #08c0ef, keyword #ff678d,
-- variable #fe8c2c, constant #ffca00, function #9d6afb, type #d568ea; ANSI
-- #ff2e3f/#0dbe4e/#009fff...), which is unreadable on the #ffffff editor
-- (1.5-2.8:1 contrast). Syntax + terminal colors below use Pierre Light's muted
-- ramp instead; only the chrome/foreground stays soft. See AGENTS.md.
vim.cmd("highlight clear")
if vim.fn.exists("syntax_on") == 1 then
    vim.cmd("syntax reset")
end
vim.g.colors_name = "pierre-light-soft"
...
-- terminal colors (muted light ramp)
...
-- base UI (soft chrome)
hl("Normal", { fg = "#525252", bg = "#ffffff" })
hl("NormalFloat", { fg = "#525252", bg = "#fafafa" })
hl("NormalNC", { fg = "#737373", bg = "#ffffff" })
hl("FloatBorder", { fg = "#8a8a8a", bg = "#fafafa" })
hl("Cursor", { fg = "#ffffff", bg = "#009fff" })
hl("CursorLine", { bg = "#f7f7f7" })
hl("CursorLineNr", { fg = "#525252", bold = true })
hl("LineNr", { fg = "#8a8a8a" })
hl("SignColumn", { bg = "#ffffff" })
hl("ColorColumn", { bg = "#f7f7f7" })
hl("Visual", { bg = "#dfebff" })
hl("Search", { fg = "#525252", bg = "#ffde80" })
hl("IncSearch", { fg = "#525252", bg = "#ffba82" })
hl("Pmenu", { fg = "#525252", bg = "#f7f7f7" })
hl("PmenuSel", { fg = "#ffffff", bg = "#009fff" })
hl("PmenuSbar", { bg = "#f7f7f7" })
hl("PmenuThumb", { bg = "#8a8a8a" })
hl("StatusLine", { fg = "#525252", bg = "#f7f7f7" })
hl("StatusLineNC", { fg = "#8a8a8a", bg = "#ffffff" })
hl("TabLine", { fg = "#8a8a8a", bg = "#f7f7f7" })
hl("TabLineSel", { fg = "#525252", bg = "#ffffff" })
hl("TabLineFill", { bg = "#f7f7f7" })
hl("WinSeparator", { fg = "#e5e5e5" })
hl("VertSplit", { fg = "#e5e5e5" })
hl("Folded", { fg = "#8a8a8a", bg = "#f7f7f7" })
hl("FoldColumn", { fg = "#a3a3a3", bg = "#ffffff" })
hl("MatchParen", { fg = "#009fff", bold = true })
hl("NonText", { fg = "#d4d4d4" })
hl("Whitespace", { fg = "#d4d4d4" })
hl("EndOfBuffer", { fg = "#ffffff" })
hl("WildMenu", { fg = "#ffffff", bg = "#009fff" })

-- syntax (muted light ramp)
